...
import { PTable, type PTableColumn, type PTableProps, type PTableSortDirection } from './PTable';
    ...
    <div style={{ display: 'grid', gap: '1rem' }}>
      <PTable<Account>
        ...
        renderRowActions={(row) => (
          <PButton size="sm" variant="secondary" onClick={() => setStatus(`Reviewing ${row.account}`)}>
            Review
          </PButton>
        )}
      />
...
const meta = {
  ...
  args: {
    ...
    summary: 'Sorted by account priority. Mobile turns rows into scannable records.',
  ...
  argTypes: {
    caption: {
      description: 'Accessible table name and visible heading unless captionHidden is true.',
    },
    summary: {
    ...
    stickyHeader: {
      description: 'Keeps column headers visible inside the horizontal scroll viewport.',
    },
    stickyFirstColumn: {
      description: 'Pins the first column on wider screens for dense enterprise tables.',
    },
    isLoading: {
...
export const CompactFinancial: Story = {
  ...
  args: {
    ...
    summary: 'Compact mode keeps finance review tables dense without losing the mobile record layout.',
  },
};
...
export const WithActions: Story = {
  ...
  args: {
    ...
    summary: 'Action columns stay pinned to the end of the table on wide screens.',
...
export const Loading: Story = {
  ...
  args: {
    ...
    summary: 'Use this state while API calls or infinite loading batches are in flight.',
  },
};
...
export const Empty: Story = {
  ...
  args: {
    ...
    summary: 'Empty states stay inside the same table frame on desktop and the same record shell on mobile.',
    emptyState: {
...
export const ControlledSorting: Story = {
  ...
  args: {
    ...
    summary: 'Header sort buttons expose aria-sort and return the requested direction.',
